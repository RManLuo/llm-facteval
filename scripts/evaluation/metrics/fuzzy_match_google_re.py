...
def eval_short_answer_question(data_dir, fout, fdetail, relation_dir, unknown_responses, template='single_answer'):
    ...
    for pred_file in all_outputs:
        ...
        relation_file = f"{relation_dir}/{relation_name}_test.jsonl"
            ...
            for line in fin:
                ...
                if not is_correct:
                    for correct_ans in record['obj_aliases']:
                        is_correct = is_correct or fuzzy_match(correct_ans, predict)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-dir', type=str, help='Data dir',
                        default='/home/tvuu0014/workspace/certfiedlm/eval-result/google_re/questions_qa/vicuna-7b-pipeline')
    ...
    parser.add_argument('--relation-dir', type=str, help='Relation dir',
                        default='/home/tvuu0014/workspace/certfiedlm/chatgptEval/kg_examples/Google_RE')
